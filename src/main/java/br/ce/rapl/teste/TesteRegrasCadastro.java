...
//	}
	...
	public static Collection<Object[]> getCollection(){
		return Arrays.asList(new Object[][] {
			...
			{"Wagner", "Costa", "Feminino", Arrays.asList("Carne"), new String[]{"Karate", "O que eh esporte?"}, "Voce faz esporte ou nao?"}
		});
	}
	...
	public void deveValidarRegras(){
		...
		Assert.assertEquals(msg, page.obterTextoAlertaEAceita());
	}
}
